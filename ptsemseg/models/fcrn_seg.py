...
### fcrn for semantic segmentation ###
# based on ResNet50
...
class fcrn_seg(nn.Module):

    def __init__(self, n_classes=19):
        super(fcrn_seg, self).__init__()
        self.inplanes = 64
        ...
        # for segmentation
        self.conv3 = nn.Conv2d(64, self.n_classes, 3, padding=1)
    ...
    #     init_state_dict = torch.load(model_path, map_location=lambda storage, loc: storage)
