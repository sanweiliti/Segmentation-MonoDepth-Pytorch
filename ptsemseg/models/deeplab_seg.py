# deeplab v2: ResNet101 + ASPP, no multi scale input (for cityscapes)
# for segmentation
...
class ResNet(nn.Module):
    def __init__(self, block, layers, n_classes):
        ...
        self.layer5 = self._make_pred_layer(Classifier_Module, [6,12,18,24],[6,12,18,24],n_classes) # ASPP
...
class deeplab_seg(nn.Module):
    def __init__(self,n_classes=19):
        ...
        self.Scale = ResNet(Bottleneck,[3, 4, 23, 3],n_classes)
