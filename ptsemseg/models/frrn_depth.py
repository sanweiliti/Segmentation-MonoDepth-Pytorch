...
class frrn_depth(nn.Module):
    ...
    def __init__(self,
                 ...
                 group_norm=False,
                 n_groups=16):
        super(frrn_depth, self).__init__()
        ...
        self.predict = nn.Conv2d(
            48, 1, kernel_size=3, padding=1, stride=1, bias=True
        )
